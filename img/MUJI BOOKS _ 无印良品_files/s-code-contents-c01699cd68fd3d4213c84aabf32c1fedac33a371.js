...
if(sc_domain.match(/www\.muji\.com/)){
 s.un = "mjimujichinaprd";
} else {
 s.un = "mjimujichinadev";
}
...
s.linkInternalFilters="javascript:,mujistg.api.yorentick.cn,st3gb.muji.net,muji.com.cn/,img.muji.com.cn,cashier.alipay.com,mapi.alipay.com,forexprod.alipay.com,trade.alipay.com,cashier.alipay.com,paycore.alipay.com,payrouter.alipay.com,trade.alipay.com,tradeexprod.alipay.com"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"

s.pageName=location.host+location.pathname.toLowerCase();
...
s.eVar2=s.getQueryParam('sc_fid');
...
s.visitorNamespace="muji"
s.trackingServer="muji.d2.sc.omtrdc.net"
